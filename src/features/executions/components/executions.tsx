...
import type { ExecutionModel as Execution } from "@/generated/prisma/models/Execution";
...
export const ExecutionsHeaders = () => {
  return (
    <EntityHeader
      title="Executions"
      description="View and manage your workflow executions history"
    />
  );
};
...
export const ExecutionsEmpty = ({ isSearching }: { isSearching?: boolean }) => {
  return (
