...
interface Props {
  ...
  defaultValues?: Partial<DeepSeekNodeData>;
}
  ...
  useEffect(() => {
    if (open) {
      form.reset({
        ...
        model: normalizeDeepSeekModel(defaultValues.model),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings for the DeepSeek AI node.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="break-all">
                    DeepSeek model to use for completion
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
